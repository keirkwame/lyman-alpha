...
class FourierEstimator3D(FourierEstimator):
    ...
    def get_correlation_function_3D_two_coords_hist_binned(self, coord_box1, coord_box2, n_bins1, n_bins2, norm = True, bin_coord1 = True, bin_coord2 = True, count = True):
        x = coord_box1.flatten()[1:] #USE BINNUMBER!!!
        y = coord_box2.flatten()[1:]
        return self._form_return_list(x,y,n_bins1,n_bins2,norm,bin_coord1,bin_coord2,count,False)
