...
if __name__ == "__main__":
    ...
    for i in [1.]: #np.arange(0.5,0.9,0.1):
        ...
        np.savez('/home/keir/Data/Illustris_big_box_spectra/snapdir_064/power_LLS_forest_64_750_10_4_7_unevenMu_kMax_%.2f.npz'%i,power_binned,k_binned,bin_counts,mu_binned) #,model_power_binned)'''
