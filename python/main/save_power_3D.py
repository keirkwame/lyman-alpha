...
if __name__ == "__main__":
    ...
    undodged_spectra_ins = box.SimulationBox(snapshot_num, snapshot_dir, grid_width, spectral_res, reload_snapshot=False, spectra_savedir=spectra_full_dir_path, spectra_savefile_root='gridded_spectra_subDLAs_forest')
    ...
    for i in [1.]: #np.arange(0.5,0.9,0.1):
        ...
        np.savez('/home/keir/Data/Illustris_big_box_spectra/snapdir_064/power_subDLAs_forest_64_750_10_4_6_evenMu_kMax_%.2f.npz'%i,power_binned,k_binned,bin_counts,mu_binned) #,model_power_binned)'''
