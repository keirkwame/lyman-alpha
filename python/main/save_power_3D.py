...
if __name__ == "__main__":
    ...
    SNAPSHOT_NUM = int(sys.argv[0])
    SNAPSHOT_DIR = sys.argv[1]
    GRID_WIDTH_IN_SAMPS = int(sys.argv[2])
    SPECTRUM_RESOLUTION = int(sys.argv[3]) * u.km / u.s
    RELOAD_SNAPSHOT = False
    SPECTRA_SAVEFILE_ROOT = 'gridded_spectra'
    SPECTRA_SAVEDIR = sys.argv[4]
    ...
    power_binned, k_binned, mu_binned, bin_counts = fourier_estimator_instance.get_power_3D_two_coords_binned(k_box,np.absolute(mu_box),k_bin_edges,mu_bin_edges,bin_coord2=True)
